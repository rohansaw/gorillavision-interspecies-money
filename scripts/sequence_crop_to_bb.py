...
output_folder = os.path.join("/Users/lukaslaskowski/Documents/HPI/gorillavision/data/kwitonda", "sequences_cropped")
...
with open(file_path, 'r') as txt_file:
        for idx, line in enumerate(txt_file):
            ...
            for file_name in elements:
                ...
                if not bbox:
                    continue
                img = Image.open(os.path.join(images_folder, file_name.strip()))
                ...
                cropped_image.save(os.path.join(output_folder, str(idx), file_name[:-4].strip() + ".png"))
                num_cropped += 1
